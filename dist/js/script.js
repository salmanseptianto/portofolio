...
gsap.to("#tulis", {
  duration: 7,
  delay: 2,
  text: "Web ini dibuat dengan tujuan untuk menampilkan informasi tentang saya, skill yang saya miliki dan, project yang telah saya kerjakan",
  ease: "none",
});

// typing
new Typed("#ketik", {
  strings: ["Student", "Designer", "Gamers", "Web Developer"],
  typeSpeed: 180,
  backSpeed: 80,
  loop: true,
});
